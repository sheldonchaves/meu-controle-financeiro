...
public class MensagemUtils {
    ...
    /**
     * Adicione uma mensagem para ser exibida na tag messagens da JSF de sua
     * página A String msg deve vir já pronta, o método não busca no resource
     * bundle
     *
     * @param String msg
    ...
    /**
     * Realiza validacao em um objeto com base nas anotacoes da especificacao
     * JSR303, aqui implemenetado pelo HibernateValidator nas entidades
     *
     * @param entidade
     * @throws NegocioException
     */
    ...
    /**
     * Realiza validacao de uma colecao de objetos com base nas anotacoes da
     * especificacao JSR303, aqui implemenetado pelo HibernateValidator nas
     * entidades
     *
     * @param entidade
     * @throws NegocioException
