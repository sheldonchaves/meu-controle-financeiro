...
public class DespesaProcedimentoBeanTest
    ...
    public void testBuscarDespesaProcedimento() throws Exception {
        ProcedimentoFacade instane = getBean();
        ...
        List<Procedimento> todos = instane.findAll();
        assertEquals("Quantidade de DespesaProcedimento não confere.",
                6, todos.size());
        final List<DespesaProcedimento> despesasT1 =
                instane.buscarDespesaProcedimento(null, null, user1);
        assertEquals("Quantidade de DespesaProcedimento não confere.",
                5, despesasT1.size());
        final List<DespesaProcedimento> despesasT2 =
                instane.buscarDespesaProcedimento(cc2, null, user1);
        assertEquals("Quantidade de DespesaProcedimento não confere.",
                1, despesasT2.size());
        final List<DespesaProcedimento> despesasT3 =
                instane.buscarDespesaProcedimento(cc1, null, user1);
        assertEquals("Quantidade de DespesaProcedimento não confere.",
                2, despesasT3.size());
