...
public class ConverterController {
    ...
    public static class UsuarioControllerConverter implements Converter {
         ...
         * @return java.lang.Object que pode ser feito cast para Usuario.
         */
        @Override
        public Object getAsObject(final FacesContext facesContext,
                final UIComponent component, final String value) {
    ...
    //====================
    // Conversor (ContaBancaria)
    //====================
    /**
     * Conversor para classe CartaoCredito em SelectItem.
     */
    @FacesConverter(forClass = ContaBancaria.class, value = "disponivelConverter")
    public static class DisponivelControllerConverter implements Converter {
        ...
        public Object getAsObject(final FacesContext facesContext,
            ...
            return controller.disponivelFacade.find(Long.parseLong(value));
        }
        ...
        public String getAsString(final FacesContext facesContext,
            ...
            if (object instanceof ContaBancaria) {
                ContaBancaria o = (ContaBancaria) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("object " + object
                        + " is of type " + object.getClass().getName()
