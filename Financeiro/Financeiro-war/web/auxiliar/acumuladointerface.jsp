...
<f:subview id="inicialView" >
    ...
    <h:outputText value="#{acumulado.meses * 2 * 2 + 2}"/>
    ...
    <a4j:repeat value="#{acumulado.acumuladoHelperDataModel}" var="titulo" id="titulolist">
        ...
        <h:outputText value="#{titulo.mesAno}" escape="false" rendered="#{!titulo.mesAtual}" styleClass="zzz">
            <f:convertDateTime pattern="MMMM/yyyy" locale="#{acumulado.locale}"/>
        </h:outputText>
    ...
    <a4j:repeat value="#{acumulado.linhasReportHelper.tipoValores}" var="linha" id="linhalist">
        <h:outputText escape="false" value="<tr>"/>
        <a4j:repeat value="#{linha}" var="coluna" id="colunalist">
            ...
            <h:outputText value="#{coluna.valor}" >
                <f:convertNumber type="currency" locale="#{acumulado.locale}"/>
            </h:outputText>
            <h:outputText escape="false" value="</td>"/>
        </a4j:repeat>
        <h:outputText escape="false" value="</tr>"/>
