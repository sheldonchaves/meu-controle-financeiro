...
<f:subview id="inicialView" >
    ...
    <h:outputText value="#{grupoGastoPagamentosDTOFaces.meses * 2 * 2 + 2}"/>
    ...
    <a4j:repeat value="#{grupoGastoPagamentosDTOFaces.grupoDataModel}" var="titulo" id="titulolist">
        ...
        <h:outputText value="#{titulo.mesAno}" escape="false" rendered="#{!titulo.mesAtual}" styleClass="zzz">
            <f:convertDateTime pattern="MMMM/yyyy" locale="#{grupoGastoPagamentosDTOFaces.locale}"/>
        </h:outputText>
    ...
    <a4j:repeat value="#{grupoGastoPagamentosDTOFaces.linhasReportHelper.tipoValores}" var="linha" id="linhalist">
        <h:outputText escape="false" value="<tr>"/>
        <a4j:repeat value="#{linha}" var="coluna" id="colunalist">
            ...
            <h:outputText value="#{coluna.valor}" >
                <f:convertNumber type="currency" locale="#{grupoGastoPagamentosDTOFaces.locale}"/>
            </h:outputText>
            <h:outputText escape="false" value="</td>"/>
        </a4j:repeat>
        <h:outputText escape="false" value="</tr>"/>
