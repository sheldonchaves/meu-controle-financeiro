...
public class ContaReceberManager implements InterfaceManager, Observer {
    ...
    public void init() {
        ...
        Logger.getLogger(this.getClass().getName()).log(Level.FINE, this.getClass().getName() + ".init() executado!");
    }
    ...
    public void end() {
        ...
        Logger.getLogger(this.getClass().getName()).log(Level.FINE, this.getClass().getName() + ".end() executado!");
    }
