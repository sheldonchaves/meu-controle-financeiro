...
public class AcumuladoMensalManager implements InterfaceManager {
    ...
    @PostConstruct
    public void init() {
        Logger.getLogger(this.getClass().getName()).log(Level.WARNING, "AcumuladoMensalManager.end() executado!");
        atualizarBarrChart();
    }
    ...
    @PreDestroy
    public void end() {
        Logger.getLogger(this.getClass().getName()).log(Level.WARNING, "AcumuladoMensalManager.init() executado!");
    }
    //====================
    //Métodos de Negócio  
    //====================
