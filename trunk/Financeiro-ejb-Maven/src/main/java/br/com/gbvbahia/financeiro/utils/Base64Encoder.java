...
public class Base64Encoder {
    ...
    public static String encryptPassword(String string) {
        ...
        try {
            ...
            throw new SecurityException("A encodificação solicitada MD5 não"
                    + " foi encontrada nesta platarforma.", nsae);
        } catch (UnsupportedEncodingException uee) {
            throw new SecurityException("UTF8 não é suportado nesta"
                    + " plantaforma.", uee);
        }
